package me.samuki.rationale.state.success
...
@Composable
internal fun RationaleSuccessContent(
    ...
    Box(
        ...
        Column(
            ...
            Text(
                text = stringResource(R.string.rationale_success_description),
        ...
        Button(
            ...
            Text(
                text = stringResource(R.string.rationale_back_button),
...
@Composable
private fun RationaleSuccessContentPreview() {
    MaterialTheme {
        RationaleSuccessContent(
            onEvent = {}
        )
    }
} 